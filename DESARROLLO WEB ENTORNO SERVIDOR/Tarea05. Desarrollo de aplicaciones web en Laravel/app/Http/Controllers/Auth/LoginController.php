...
class LoginController extends Controller
{
    ...
    public function mostrarFormularioLoginMPG() 
    {
        return view('auth.login');
    }

    // Realizar el inicio de sesión autenticada
    public function loginMPG(Request $request) {
    ...
    public function logoutMPG(Request $request) // Sustituye XYZ por tus iniciales
    {
        Auth::logout();

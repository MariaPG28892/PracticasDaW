...
public class GestorEntidadesJPA {
    ...
    public static void insertarEmpleado() {
        String idEmpleado = EntradaTeclado.cadenaLimitada("Código de empleado:", 4, 4); //Longitud del código de producto 4 caracteres
    ...
    public static void consultarEmpleado() {
        ...
        if (empleado != null) {
            ...
            System.out.println(Color.rojo("ERROR: No existe ningún producto con código " + idEmpleado + "."));
        }
    }
    ...
    public static void listarEmpleados() {
        ...
        for (Empleado e : empleados) {
            if (idSeccion.equals(e.getSeccion().getIdSeccion()) || idSeccion.isEmpty()) {
                System.out.printf("%n%-16s %-30s %-25s %-15s %n",
                        e.getIdEmpleado(),
                        e.getNombre(),
                        e.getSalarioAnual(),
    ...
    public static void modificarEmpleado() {
        String idEmpleado = EntradaTeclado.cadenaLimitada("Código de producto:", 4, 4);  // Limitar a 10 caracteres
        Empleado empleado = empleadoDAO.buscar(idEmpleado);
        if (empleado == null) {
